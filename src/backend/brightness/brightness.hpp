...
public:
    ...
    bool hasKeyboardBacklight() const {
        return m_hasKeyboardBacklight;
    }
    qreal keyboardValue() const {
        return m_keyboardValue;
    }
    int keyboardBacklightValue() const;
    int maxKeyboardBacklightValue() const {
